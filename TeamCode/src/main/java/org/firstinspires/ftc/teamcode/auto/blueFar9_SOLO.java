...
@Autonomous(name = "Blue Solo Far 9")
public class blueFar9_SOLO extends LinearOpMode {
    ...
    private final Pose startPose = new Pose(57.9258, 9.222, Math.PI);
    private final Pose shootPose = new Pose(58.9258, 14.222, Math.PI);
    private final Pose setUp3 = new Pose(92,28, Math.toRadians(0)).mirror();
    private final Pose spike3 = new Pose(132, 38, Math.toRadians(0)).mirror();
    private final Pose humanSetup = new Pose(13.79, 29.5, -1.9325);
    private final Pose human = new Pose(11.042, 12.7476, -1.7325);
    private final Pose leavePose = new Pose(50.9413, 35.391, Math.PI);
