...
@Autonomous(name = "Blue Solo 18 Close Spline")
public class blueCloseSpline18 extends LinearOpMode {
    ...
    public enum PathState {
        DRIVE_START_POS_SHOOT_POS, SPIKE_ONE, RETURN_SHOOT1, SHOOT_ONE, SPIKE_TWO, RETURN_SHOOT2, SHOOT_TWO, SPIKE_THREE, RETURN_SHOOT3, GINTAKE, RETURN_SHOOT_GINTAKE, GINTAKE_SHOOT, GINTAKE2, RETURN_SHOOT_GINTAKE2, GINTAKE_SHOOT2, IDLE_GATE, IDLE_GATE2, SHOOT_THREE
    }
    ...
    private final Pose startPose = new Pose(27.4225,127.3841, 2.4613);
    private final Pose PreshootPose = new Pose(85.8,75.24, Math.toRadians(38.937)).mirror();
    private final Pose shootPose = new Pose(85.8,79.24, Math.toRadians(270)).mirror();
    private final Pose gintakeShootPose = new Pose(85.8,79.24, 0).mirror();
    private final Pose lastShootPose = new Pose(88,115, 0).mirror();
    private final Pose spike1 = new Pose(24.49, 82.417, Math.toRadians(-90));
    private final Pose setUp2 = new Pose(46, 62.942, -2.593);
    private final Pose leave2 = new Pose(110, 58.2, Math.toRadians(0)).mirror();
    private final Pose spike2 = new Pose(133,58.2,Math.toRadians(0)).mirror();
    private final Pose setUp3 = new Pose(51.24, 41.105, -2.496);
    private final Pose spike3 = new Pose(135, 35, Math.toRadians(0)).mirror();
    private final Pose gintakeAwayPose1 = new Pose(108.65, 57.4, 0).mirror();
    private final Pose gintakePose = new Pose(13.117, 58.729, 2.6074);
    ...
    public void buildPaths() {
        ...
        spikeTwo = follower.pathBuilder()
                .addPath(new BezierCurve(PreshootPose, setUp2, spike2))
                .setTangentHeadingInterpolation()
                .build();
        returnToShoot2 = follower.pathBuilder()
                .addPath(new BezierCurve(spike2, setUp2, gintakeShootPose))
                .setTangentHeadingInterpolation()
                .setReversed()
                .build();
        spikeThree = follower.pathBuilder()
                .addPath(new BezierCurve(gintakeShootPose, setUp3, spike3))
                .setTangentHeadingInterpolation()
                .build();
        returnToShoot3 = follower.pathBuilder()
                .addPath(new BezierCurve(spike3, setUp3, shootPose))
                .setTangentHeadingInterpolation()
                .setReversed()
                .build();
        gintake = follower.pathBuilder()
                .addPath(new BezierLine(gintakeShootPose, gintakeAwayPose1))
                .setLinearHeadingInterpolation(gintakeShootPose.getHeading(), gintakeAwayPose1.getHeading())
        ...
        returnToShootGintake = follower.pathBuilder()
                ...
                .addPath(new BezierLine(gintakeAwayPose1, gintakeShootPose))
                .setLinearHeadingInterpolation(gintakeAwayPose1.getHeading(), gintakeShootPose.getHeading())
                .build();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        StateMachine machine = new StateMachineBuilder()
                ...
                .transition( () -> follower.atPose(PreshootPose, 1, 1), PathState.SPIKE_TWO)
                ...
                .transition( () -> follower.atPose(gintakeShootPose, 0.5, 0.5), PathState.SHOOT_TWO)
                ...
                .transition( () -> follower.atPose(gintakeShootPose, 0.5, 0.5), PathState.GINTAKE_SHOOT)
                .transitionTimed(2, PathState.GINTAKE_SHOOT)
                ...
                .transition( () -> follower.atPose(gintakeShootPose, 0.5, 0.5, Math.toRadians(5)), PathState.GINTAKE_SHOOT2)
                .transitionTimed(2, PathState.GINTAKE_SHOOT2)
