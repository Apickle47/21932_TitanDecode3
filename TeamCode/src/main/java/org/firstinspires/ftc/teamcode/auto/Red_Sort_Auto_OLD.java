...
@Autonomous
public class Red_Sort_Auto_OLD extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        turret = new Turret(hardwareMap, util.deviceConf, new Pose(117.771,126.922,Math.toRadians(40.937)), follower);
        ...
        StateMachine machine = new StateMachineBuilder()
                ...
                .transitionTimed(shootTime, PathState.RETURN_SHOOT2)
