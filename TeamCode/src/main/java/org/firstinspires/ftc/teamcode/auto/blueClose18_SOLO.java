...
@Autonomous(name = "Blue Solo 18 Close")
public class blueClose18_SOLO extends LinearOpMode {
    ...
    private final Pose spike1 = new Pose(125, 84.14, Math.toRadians(0)).mirror();
    private final Pose setUp2 = new Pose(95, 58.2, Math.toRadians(0)).mirror();
    private final Pose leave2 = new Pose(120, 58.2, Math.toRadians(0)).mirror();
    private final Pose spike2 = new Pose(133,59.2,Math.toRadians(0)).mirror();
    private final Pose setUp3 = new Pose(90,31, Math.toRadians(0)).mirror();
    private final Pose spike3 = new Pose(130, 38, Math.toRadians(0)).mirror();
    private final Pose gintakeAwayPose1 = new Pose(105.65, 60.4, 0).mirror();
    private final Pose gintakePose = new Pose(12.517, 58.729, 2.6074);
    ...
    public void buildPaths() {
        ...
        driveStartPosShootPos = follower.pathBuilder()
                ...
                .addParametricCallback(.7, () -> intake.setAllPower(1))
        ...
        returnToShoot3 = follower.pathBuilder()
                ...
                .setConstantHeadingInterpolation(-2.254722)
                .build();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        StateMachine machine = new StateMachineBuilder()
                ...
                .transition( () -> follower.atPose(shootPose, 0.5, 0.5), PathState.GINTAKE_SHOOT)
                .transitionTimed(3, PathState.GINTAKE_SHOOT)
                ...
                .transition( () -> follower.atPose(shootPose, 0.5, 0.5), PathState.GINTAKE_SHOOT2)
                .transitionTimed(3, PathState.GINTAKE_SHOOT2)
