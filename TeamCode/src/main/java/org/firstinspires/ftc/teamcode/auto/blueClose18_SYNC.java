...
@Autonomous(name = "Blue Sync 18 Close")
public class blueClose18_SYNC extends LinearOpMode {
    ...
    public enum PathState {
        DRIVE_START_POS_SHOOT_POS, SPIKE_ONE, RETURN_SHOOT1, SHOOT_ONE, SPIKE_TWO, RETURN_SHOOT2, SHOOT_TWO, GINTAKE, RETURN_SHOOT_GINTAKE, GINTAKE_SHOOT, GINTAKE2, RETURN_SHOOT_GINTAKE2, GINTAKE_SHOOT2, IDLE_GATE, IDLE_GATE2, GINTAKE3, RETURN_SHOOT_GINTAKE3, GINTAKE_SHOOT3, IDLE_GATE3
    }
    ...
    private final Pose gintakePose = new Pose(12.47, 59.06086, 2.628);


    private PathChain driveStartPosShootPos, spikeOne, spikeTwo, returnToShoot1, returnToShoot2, gintake, returnToShootGintake;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        StateMachine machine = new StateMachineBuilder()
                ...
                .transitionTimed(shootTime, PathState.GINTAKE3)





                .state(PathState.GINTAKE3)
                .onEnter( () -> {
                    shooting = false;
                    gate.setPosition(Gate.CLOSE);
                    follower.followPath(gintake, true);
                ...
                .transitionTimed(1.5, PathState.IDLE_GATE3)

                .state(PathState.IDLE_GATE3)
                .onEnter( () -> {
                    gate.setPosition(Gate.CLOSE);
                })
                .loop( () -> {
                ...
                .transition( () -> ballCount == 3, PathState.RETURN_SHOOT_GINTAKE3)
                .transitionTimed(3, PathState.RETURN_SHOOT_GINTAKE3)

                .state(PathState.RETURN_SHOOT_GINTAKE3)
                .onEnter( () -> {
                    shooting = true;
                    follower.followPath(returnToShootGintake, true);
                    intake.setAllPower(0);
                ...
                .transition( () -> follower.atPose(shootPose, 0.5, 0.5, Math.toRadians(5)), PathState.GINTAKE_SHOOT3)

                .state(PathState.GINTAKE_SHOOT3)
                .onEnter( () -> {
                    //turret.setAngleOffset(-4);
                })
                .loop( () -> {
